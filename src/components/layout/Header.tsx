    ...
    const handleScroll = () => {
      if (!ticking) {
        requestAnimationFrame(() => {
          ...
          // Use larger hysteresis gap to prevent bouncing
          // When not scrolled, require 80px to trigger scrolled state
          // When scrolled, require dropping below 30px to trigger not-scrolled state
